...
;layui.define("layer", function (e) {
    ...
    u.prototype.set = function (e) {
        ...
        var a = this, n = {
            select: function () {
                var e = "请选择", a = "layui-form-select", b="layui-select-disabled",t = "layui-select-title", n = i(s).find("select"), u = function (e, n) {
                    i(e.target).parent().hasClass(t) && !n || i("." + a).removeClass(a + "ed")
                }, o = function (e, n) {
                    var s = i(this), o = e.find("." + t);
                    //添加select不能点击事件
                    if(o.parents().hasClass(b)){
                        o.children('input').addClass('layui-disabled-normal');
                        return false;
                    }
